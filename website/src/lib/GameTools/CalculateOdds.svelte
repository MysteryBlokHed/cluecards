...
<div>
    ...
    <br />
    Try to find the most likely murder cards. Probabilities are not foolproof&mdash;only use this as a
    last-resort if you think a player is going to make a correct accusation before you.
</div>
