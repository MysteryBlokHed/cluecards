...
///
/// Since there may be multiple minimum hititng sets, this function returns a list of them all.
///
/// If the return type is [Some], the first element is the size of the minimum hitting set
/// (i.e. the size of all the sets in the [Vec]), and the [Vec] is the list of minimum sets.
